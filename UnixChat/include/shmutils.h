...
/*
* ===============================================
 *  ** ВКЛЮЧЕНИЕ ПОЛЬЗОВАТЕЛЯ В СПИСОК **
 *  
 *  Проходим по списку пользователей и ищем
 *  первую позицию, значение в которой -1
 * 
 *  Вставляем туда pid нового пользователя
 * 
 *  Возвращаемое значение: номер, который
 *  нужно присвоить пользователю
 * 
* ===============================================
*/
 ...
 * 
 *  Отправляем по этому pid сигнал всем таким
 *  пользователям (кроме себя же)
 * 
* ===============================================
*/
